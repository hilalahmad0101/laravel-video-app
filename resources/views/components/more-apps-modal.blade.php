<div id='modal4' class="bg-black/70 fixed h-screen w-full top-0 left-0 hidden translate-x z-[999]">
    <div id="defaultModal"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                    ...
                    <button id='hide_links_modal' type="button"
                ...
                <form action="{{ route('store.link') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class='px-10'>
                        <label htmlFor="" class='text-[#1F2937]'>Enter New Social Name</label>
                    ...
                    <div class='px-10'>
                        <label htmlFor="" class='text-[#1F2937]'>Enter New Social Link</label>
                    ...
                    <div class='px-10'>
                        <label htmlFor="" class='text-[#1F2937]'>Enter New Social Icon</label>
