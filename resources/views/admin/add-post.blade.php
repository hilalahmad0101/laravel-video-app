                    ...
                    <div class="bg-white py-9 rounded-lg ">
                        <div class="my-3 px-10 grid md:grid-cols-2 grid-cols-1 gap-8">
                            <div class="my-3 ">
                                ...
                                <input type="text" name="title" name="title" id=""
                        ...
                        <div class="my-3 px-10 grid md:grid-cols-2 grid-cols-1 gap-8">
                            <div class=' '>
                                ...
                                <input type="text" name="tags" name="tags" id=""
                                    class='py-3 px-2 w-full border my-3 rounded-lg outline-none' />
                                @error('tags')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                                    ...
                                    <label htmlFor="dropzone-file"
                                        ...
                                        <div class="flex flex-col justify-center items-center py-3 px-2  ">
                                            <p class="mb-2 text-sm text-gray-500 ">
                                                <img src="{{ asset('public/assets/vector2.png') }}" id="show_image"  alt="" />
                                            </p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                                Drag and Drop or Browser
                                            </p>
                                        </div>
                                        <input  type="file" name="file" id="preivew" class="hidden" />
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="my-3 px-10 grid md:grid-cols-2 grid-cols-1 gap-8">
                            <div>
                                ...
                                <input type="time" name="posting_time" name="posting_time" id=""
                                    class='py-3 px-2 w-full border my-3 rounded-lg outline-none' />
                                @error('posting_time')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" name="posting_date" name="posting_date" id=""
                                    class='py-3 px-2 w-full border my-3 rounded-lg outline-none' />
                                @error('posting_date')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div>
                            <div class='ml-9 flex items-center'>
                                <input type="checkbox" class='h-5 w-5' name="notification" name="notification"
                                    id="" />
                                @error('notification')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
